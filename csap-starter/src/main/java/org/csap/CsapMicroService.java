...
/**
 * 
 * CSAP MicroService - provides integration by importing {@link CsapBootConfig }
 * . Used to indicate
 * <ul>
 * <li>service is part of a clustered set of services</li>
 * <li>Optional: leverages client side loadbalancing techniques (eg.
 * {@link CsapServiceLocator } ) to retrieve endpoints from service catalogs
 * </li>
 * <li>Optional: does not require enterprise load balancers, either soft (eg.
 * {@link CsapWebServerConfig } ), or hard (routers)</li>
 * 
 * </ul>
 * 
...
public @interface CsapMicroService {
