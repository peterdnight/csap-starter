...
@RestController
@CsapDoc(title = "Demo Service Locator",
		notes = "A simple service for demoing core spring concepts")
public class HelloService {
	...
	@CsapDoc(notes="Output hello in json format. Optional support for JSONP if the callback parameter is included",
			linkTests = { "JSON Example", "JSONP Example"},
			linkGetParams = {"none=none", "callback=myDemoFunctionName"})
	...
	public ObjectNode sleep(@PathVariable int seconds) throws InterruptedException {
